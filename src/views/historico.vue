    ...
    <div>
        <div class="cabecalho">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group">
                    <button class="btn btn-dark" alt="Recarregar Página" :disabled="$store.getters.getLoading" @click="onPageChange(1)"><i class="fa-solid fa-rotate" :class="{ 'fa-spin' : $store.getters.getLoading }"></i></button>
                </div>
            </div>
        </div>
